...
PHANTOM_ERR_INVALID_INT = (
    "Please provide a valid {msg} integer value in the '{param}' action parameter"
)
...
PHANTOM_ERR_CONTAINER_ARTIFACT = (
    "Please provide container_artifacts as a list of artifact objects in JSON format"
)
...
PHANTOM_ERR_NON_EMPTY_PARAM_VALUE = (
    "Please provide row_values_as_list parameter as a non-empty JSON formatted list"
)
...
ARTIFACT_ABSOLUTE_MAX_RESULTS = 10000
